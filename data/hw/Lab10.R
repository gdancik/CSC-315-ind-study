####################################################################
# Name:
# Lab 10: Identification of differentially expressed genes
...
########################################################
# We start by retrieving and processing the data
...
# (a) construct design matrix, and rename the columns 'HG', 'LG', and 'unknown'
#     Note that the columns must be named because the default values do not
#     allow you to specify the contrasts
...
#    You should specifically look at the probe "ENSG00000198670.10"
